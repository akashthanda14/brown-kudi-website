  ...
  const products = [
    {
      ...
      detail: {
        english: "Super Seeder is used for sowing seeds directly into the soil while simultaneously mulching crop residue. It saves time, fuel, and helps in better crop growth.",
        hindi: "सुपर सीडर का उपयोग बीज को सीधे मिट्टी में बोने और फसल के अवशेष को एक साथ मिलाने के लिए किया जाता है। यह समय, डीज़ल की बचत करता है और फसल की बेहतर पैदावार में मदद करता है।",
        punjabi: "ਸੁਪਰ ਸੀਡਰ ਬੀਜਾਂ ਨੂੰ ਸਿੱਧਾ ਮਿੱਟੀ ਵਿੱਚ ਬੋਣ ਲਈ ਵਰਤਿਆ ਜਾਂਦਾ ਹੈ ਅਤੇ ਨਾਲ ਹੀ ਫਸਲ ਦੇ ਅਵਸ਼ੇਸ਼ਾਂ ਨੂੰ ਮਿਲਾਉਂਦਾ ਹੈ। ਇਹ ਸਮਾਂ, ਡੀਜ਼ਲ ਬਚਾਉਂਦਾ ਹੈ ਅਤੇ ਫਸਲ ਦੀ ਵਧੀਆ ਪੈਦਾਵਾਰ ਵਿੱਚ ਮਦਦ ਕਰਦਾ ਹੈ।",
      },
    },
    {
      id: 2,
      ...
      detail: {
        english: "The reversible MB plough is used for primary tillage of soil. It turns over the soil, buries crop residue, and makes the land ready for sowing.",
        hindi: "रिवर्सेबल एम.बी. हल का उपयोग खेत की जुताई के लिए किया जाता है। यह मिट्टी को पलटता है, फसल के अवशेष दबाता है और भूमि को बुवाई के लिए तैयार करता है।",
        punjabi: "ਰੀਵਰਸੇਬਲ ਐਮ.ਬੀ. ਹਲ ਮਿੱਟੀ ਦੀ ਮੁੱਢਲੀ ਜੁਤਾਈ ਲਈ ਵਰਤਿਆ ਜਾਂਦਾ ਹੈ। ਇਹ ਮਿੱਟੀ ਨੂੰ ਪਲਟਦਾ ਹੈ, ਫਸਲ ਦੇ ਅਵਸ਼ੇਸ਼ ਦਬਾਉਂਦਾ ਹੈ ਅਤੇ ਖੇਤ ਨੂੰ ਬੀਜਾਈ ਲਈ ਤਿਆਰ ਕਰਦਾ ਹੈ।",
      },
    },
    {
      id: 3,
      ...
      detail: {
        english: "Disc Harrow is used for breaking clods, leveling the soil, and mixing crop residue into the field. It helps in preparing a fine seedbed.",
        hindi: "डिस्क हैरो का उपयोग मिट्टी की ढेलों को तोड़ने, जमीन को समतल करने और फसल अवशेषों को मिट्टी में मिलाने के लिए किया जाता है। यह अच्छे बीज-बेड बनाने में सहायक है।",
        punjabi: "ਡਿਸਕ ਹੈਰੋ ਮਿੱਟੀ ਦੇ ਢੇਲਿਆਂ ਨੂੰ ਤੋੜਨ, ਜ਼ਮੀਨ ਨੂੰ ਸਮਤਲ ਕਰਨ ਅਤੇ ਫਸਲ ਦੇ ਅਵਸ਼ੇਸ਼ਾਂ ਨੂੰ ਖੇਤ ਵਿੱਚ ਮਿਲਾਉਣ ਲਈ ਵਰਤਿਆ ਜਾਂਦਾ ਹੈ। ਇਹ ਵਧੀਆ ਬੀਜ-ਬੈੱਡ ਬਣਾਉਣ ਵਿੱਚ ਮਦਦ ਕਰਦਾ ਹੈ।",
      },
    },
    {
      id: 4,
      ...
      detail: {
        english: "Rotavator is a secondary tillage implement used for pulverizing soil, mixing manure, and removing weeds. It reduces time and labor in field preparation.",
        hindi: "रोटावेटर एक जुताई उपकरण है जिसका उपयोग मिट्टी को भुरभुरा करने, खाद मिलाने और खरपतवार हटाने के लिए किया जाता है। यह खेत की तैयारी में समय और मेहनत बचाता है।",
        punjabi: "ਰੋਟਾਵੇਟਰ ਮਿੱਟੀ ਨੂੰ ਭੁਰਭੁਰਾ ਕਰਨ, ਖਾਦ ਮਿਲਾਉਣ ਅਤੇ ਘਾਹ-ਫੂਸ ਨੂੰ ਹਟਾਉਣ ਲਈ ਵਰਤਿਆ ਜਾਂਦਾ ਹੈ। ਇਹ ਖੇਤ ਦੀ ਤਿਆਰੀ ਵਿੱਚ ਸਮਾਂ ਅਤੇ ਮਜ਼ਦੂਰੀ ਬਚਾਉਂਦਾ ਹੈ।",
      },
    },
    {
      id: 5,
      ...
      detail: {
        english: "Subsoiler – A deep tillage implement used with tractors. It breaks hardpan soil, improves root growth, water absorption, and soil aeration, leading to higher crop yield and better soil health.",
        hindi: "सब-सोइलर – ट्रैक्टर से जुड़ने वाला गहरी जुताई का यंत्र। यह कठोर मिट्टी को तोड़कर जड़ों की वृद्धि, पानी सोखने और मिट्टी की उर्वरकता को बढ़ाता है।",
        punjabi: "ਸਬਸੋਇਲਰ – ਟਰੈਕਟਰ ਨਾਲ ਜੋੜ ਕੇ ਡੂੰਘੀ ਜੁੱਤੀ ਲਈ ਵਰਤਿਆ ਜਾਣ ਵਾਲਾ ਯੰਤਰ। ਇਹ ਸਖ਼ਤ ਮਿੱਟੀ ਨੂੰ ਤੋੜ ਕੇ ਜੜ੍ਹਾਂ ਦੀ ਵਾਧ, ਪਾਣੀ ਸੋਖਣ ਅਤੇ ਮਿੱਟੀ ਦੀ ਉਪਜਾਊ ਸ਼ਕਤੀ ਵਧਾਉਂਦਾ ਹੈ।",
      },
    },
    {
      id: 6,
